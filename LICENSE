...
Copy, modify, reproduce, distribute, or sell any part of this software, its source code, or its underlying infrastructure.

Reverse engineer, decompile, or attempt to extract the source code of this platform.
...
You MAY NOT use these trademarks, names, or branding elements in any capacity—including in domains, app names, or marketing—without express written permission.
